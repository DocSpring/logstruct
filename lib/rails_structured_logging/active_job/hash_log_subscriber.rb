...
module RailsStructuredLogging
  module ActiveJob
    # Custom LogSubscriber for ActiveJob that outputs logs in JSON format
    class HashLogSubscriber < ::ActiveJob::LogSubscriber
      def enqueue(event)
      ...
      def log_job_event(event_name, job, _event, additional_data = {})
        ...
        # Use Rails logger with our JSON formatter
