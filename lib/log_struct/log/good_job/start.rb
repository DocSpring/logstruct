  ...
  module Log
    class GoodJob
      class Start < T::Struct
        ...
        const :event, Event::Start, default: T.let(Event::Start, Event::Start)
        ...
        def serialize(strict = true)
          ...
          h[LogField::WaitMs.serialize] = wait_ms if wait_ms
          h[LogField::ScheduledAt.serialize] = scheduled_at&.iso8601 if scheduled_at
          h
        end
      end
    end
