  ...
  module Log
    class GoodJob
      class Schedule < T::Struct
        ...
        const :event, Event::Schedule, default: T.let(Event::Schedule, Event::Schedule)
        ...
        def serialize(strict = true)
          ...
          h[LogField::ScheduledAt.serialize] = scheduled_at.iso8601
          h[LogField::Priority.serialize] = priority if priority
          h[LogField::CronKey.serialize] = cron_key if cron_key
          h
        end
      end
    end
