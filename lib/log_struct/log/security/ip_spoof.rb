  ...
  module Log
    class Security
      class IPSpoof < T::Struct
        ...
        const :event, Event::IPSpoof, default: T.let(Event::IPSpoof, Event::IPSpoof)
        ...
        def serialize(strict = true)
          ...
          h[LogField::ClientIp.serialize] = client_ip if client_ip
          h[LogField::XForwardedFor.serialize] = x_forwarded_for if x_forwarded_for
          h
        end
      end
    end
