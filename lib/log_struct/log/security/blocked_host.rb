  ...
  module Log
    class Security
      class BlockedHost < T::Struct
        ...
        const :event, Event::BlockedHost, default: T.let(Event::BlockedHost, Event::BlockedHost)
        ...
        def serialize(strict = true)
          ...
          h[LogField::BlockedHost.serialize] = blocked_host if blocked_host
          h[LogField::BlockedHosts.serialize] = blocked_hosts if blocked_hosts
          h
        end
      end
    end
