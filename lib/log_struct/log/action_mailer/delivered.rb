  ...
  module Log
    class ActionMailer
      class Delivered < T::Struct
        ...
        const :event, Event::Delivered, default: T.let(Event::Delivered, Event::Delivered)
        ...
        def serialize(strict = true)
          ...
          h[LogField::To.serialize] = to if to
          h[LogField::From.serialize] = from if from
          h[LogField::Subject.serialize] = subject if subject
