  ...
  module Integrations
    ...
    module Lograge
      ...
      def self.setup(config)
        ...
        return unless config.integrations.enable_lograge
      ...
      def self.lograge_default_options(event)
      ...
      def self.process_headers(event, options)
      ...
      sig { params(event: ActiveSupport::Notifications::Event, options: T::Hash[Symbol, T.untyped]).void }
      def self.apply_custom_options(event, options)
