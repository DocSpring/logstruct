...
class Honeybadger::Backend::Test < ::Honeybadger::Backend::Null
  # source://honeybadger//lib/honeybadger/backend/test.rb#59
  def check_in(id); end

  # source://honeybadger//lib/honeybadger/backend/test.rb#41
  def check_ins; end

  # source://honeybadger//lib/honeybadger/backend/test.rb#54
  def event(payload); end
  ...
  # source://honeybadger//lib/honeybadger/backend/test.rb#49
  def notify(feature, payload); end
...
class Honeybadger::Backtrace
  ...
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#127
  def initialize(lines); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#162
  def ==(other); end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#115
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#143
  def as_json(options = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#158
  def inspect; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#135
  def to_a; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#150
  def to_json(*a); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#154
  def to_s; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#172
  ...
  class << self
    # @api private
    #
    # source://honeybadger//lib/honeybadger/backtrace.rb#117
    def parse(ruby_backtrace, opts = T.unsafe(nil)); end

    # @api private
    #
    # source://honeybadger//lib/honeybadger/backtrace.rb#174
...
class Honeybadger::Backtrace::Line
  ...
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#53
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#70
  def ==(other); end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#79
  def application?; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#14
  def file; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#23
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#74
  def inspect; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#20
  def method; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#17
  def number; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#83
  def source; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#66
  def to_s; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#89
  def file=(_arg0); end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#96
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/backtrace.rb#91
  ...
  class << self
    ...
    #
    # source://honeybadger//lib/honeybadger/backtrace.rb#30
...
# @api private
#
# source://honeybadger//lib/honeybadger/backtrace.rb#11
