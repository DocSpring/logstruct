...
module Bugsnag
  ...
  class << self
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#421
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#357
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#330
    ...
    # @return [Boolean]
    #
    # source://bugsnag//lib/bugsnag.rb#176
    ...
    #
    # source://bugsnag//lib/bugsnag.rb#235
    ...
    #
    # source://bugsnag//lib/bugsnag.rb#380
    def breadcrumbs; end
    ...
    # @return [Cleaner]
    #
    # source://bugsnag//lib/bugsnag.rb#390
    def cleaner; end
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#438
    ...
    #
    # source://bugsnag//lib/bugsnag.rb#184
    ...
    #
    # source://bugsnag//lib/bugsnag.rb#54
    ...
    #
    # source://bugsnag//lib/bugsnag.rb#448
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#275
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#258
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#243
    ...
    # @return [Hash]
    #
    # source://bugsnag//lib/bugsnag.rb#401
    def metadata; end
    ...
    #
    # source://bugsnag//lib/bugsnag.rb#73
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#315
    ...
    # @see resume_session
    #
    # source://bugsnag//lib/bugsnag.rb#214
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#152
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#369
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#342
    ...
    # @see pause_session
    #
    # source://bugsnag//lib/bugsnag.rb#225
    ...
    #
    # source://bugsnag//lib/bugsnag.rb#193
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag.rb#203
    def start_session; end

    private

    # source://bugsnag//lib/bugsnag.rb#462
    ...
    # @return void
    #
    # source://bugsnag//lib/bugsnag.rb#479
    ...
    # @return [String]
    #
    # source://bugsnag//lib/bugsnag.rb#543
    def report_to_json(report); end

    # @return [Boolean]
    #
    # source://bugsnag//lib/bugsnag.rb#454
    ...
    # @return [Exception]
    #
    # source://bugsnag//lib/bugsnag.rb#560
...
# source://bugsnag//lib/bugsnag/breadcrumbs/on_breadcrumb_callback_list.rb#1
...
# source://bugsnag//lib/bugsnag/breadcrumbs/on_breadcrumb_callback_list.rb#2
class Bugsnag::Breadcrumbs::OnBreadcrumbCallbackList
  ...
  #
  # source://bugsnag//lib/bugsnag/breadcrumbs/on_breadcrumb_callback_list.rb#3
  def initialize(configuration); end

  # @param callback [Proc, Method, #call]
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/breadcrumbs/on_breadcrumb_callback_list.rb#12
  def add(callback); end

  # @param breadcrumb [Breadcrumb]
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/breadcrumbs/on_breadcrumb_callback_list.rb#30
  def call(breadcrumb); end

  # @param callback [Proc, Method, #call]
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/breadcrumbs/on_breadcrumb_callback_list.rb#21
...
class Bugsnag::Breadcrumbs::Validator
  ...
  #
  # source://bugsnag//lib/bugsnag/breadcrumbs/validator.rb#15
  def validate(breadcrumb); end
end

# @api private
#
# source://bugsnag//lib/bugsnag/cleaner.rb#3
class Bugsnag::Cleaner
  # @api private
  # @param configuration [Configuration]
  # @return [Cleaner] a new instance of Cleaner
  #
  # source://bugsnag//lib/bugsnag/cleaner.rb#12
  def initialize(configuration); end

  # @api private
  #
  # source://bugsnag//lib/bugsnag/cleaner.rb#16
  ...
  # @return [String]
  #
  # source://bugsnag//lib/bugsnag/cleaner.rb#25
  ...
  # @api private
  #
  # source://bugsnag//lib/bugsnag/cleaner.rb#205
  def clean_generic_url(original_url, uri); end

  # @api private
  #
  # source://bugsnag//lib/bugsnag/cleaner.rb#214
  ...
  # @api private
  #
  # source://bugsnag//lib/bugsnag/cleaner.rb#223
...
# @api private
#
# source://bugsnag//lib/bugsnag/cleaner.rb#4
...
# source://bugsnag//lib/bugsnag/configuration.rb#28
class Bugsnag::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#224
  def initialize; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#664
  def add_metadata(section, key_or_data, *args); end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#632
  def add_on_breadcrumb(callback); end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#605
  def add_on_error(callback); end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#31
  def api_key; end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#343
  def app_type; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#355
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#63
  def app_version; end
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#44
  def auto_notify; end
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#736
  def auto_track_sessions; end

  # @param track_sessions [Boolean]
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#742
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#683
  def clear_metadata(section, *args); end
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#697
  def context_set?; end
  ...
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#464
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#331
  ...
  # @return [Symbol]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#307
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#319
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#365
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#379
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#575
  ...
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#127
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#145
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#150
  ...
  # @see Bugsnag::BreadcrumbType
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#723
  def enabled_breadcrumb_types; end

  # @param breadcrumb_types [Array<String>]
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#729
  ...
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#709
  def enabled_release_stages; end

  # @param release_stages [Array<String>, nil]
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#715
  ...
  # @return [String]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#506
  def endpoint; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#518
  ...
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#140
  def endpoints; end

  # source://bugsnag//lib/bugsnag/configuration.rb#554
  ...
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#136
  ...
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#91
  ...
  # @return [Integer]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#164
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#486
  ...
  # @return [Set<String, Regexp>]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#69
  ...
  # @return [Hash]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#186
  def metadata; end
  ...
  # @return [MiddlewareStack]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#87
  def middleware; end
  ...
  # @return [Array<String>, nil]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#40
  ...
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#195
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#590
  def on_error(&block); end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#473
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#59
  ...
  # @see parse_proxy
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#96
  def proxy_host; end
  ...
  # @see parse_proxy
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#101
  def proxy_port; end
  ...
  # @see parse_proxy
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#106
  def proxy_user; end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#35
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#644
  def remove_on_breadcrumb(callback); end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#617
  def remove_on_error(callback); end
  ...
  # @return [Hash]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#405
  def request_data; end

  # @api private
  # @return [Hash{String => String}]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#123
  ...
  # @return [String]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#527
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#538
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#550
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#415
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#396
  def valid_api_key?; end

  # @deprecated Use {vendor_paths} instead
  # @return [Regexp]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#168
  def vendor_path; end
  ...
  # @return [Array<String>]
  #
  # source://bugsnag//lib/bugsnag/configuration.rb#177
  ...
  # source://bugsnag//lib/bugsnag/configuration.rb#752
...
# source://bugsnag//lib/bugsnag/configuration.rb#750
Bugsnag::Configuration::PROG_NAME = T.let(T.unsafe(nil), String)

# source://bugsnag//lib/bugsnag/configuration.rb#198
...
# source://bugsnag//lib/bugsnag/delivery/synchronous.rb#5
class Bugsnag::Delivery::Synchronous
  class << self
    # Attempts to deliver a payload to the given endpoint synchronously.
    #
    # source://bugsnag//lib/bugsnag/delivery/synchronous.rb#9
    def deliver(url, body, configuration, options = T.unsafe(nil)); end

    private

    # source://bugsnag//lib/bugsnag/delivery/synchronous.rb#57
    def default_headers; end

    # source://bugsnag//lib/bugsnag/delivery/synchronous.rb#53
    def path(uri); end

    # source://bugsnag//lib/bugsnag/delivery/synchronous.rb#27
    def request(url, body, configuration, options); end
  end
end

# source://bugsnag//lib/bugsnag/delivery/thread_queue.rb#3
class Bugsnag::Delivery::ThreadQueue < ::Bugsnag::Delivery::Synchronous
  class << self
    ...
    # @return [void]
    #
    # source://bugsnag//lib/bugsnag/delivery/thread_queue.rb#17
    def serialize_and_deliver(url, get_payload, configuration, options = T.unsafe(nil)); end

    private

    # source://bugsnag//lib/bugsnag/delivery/thread_queue.rb#42
    def start_once!; end
  end
end

# source://bugsnag//lib/bugsnag/delivery/thread_queue.rb#4
...
#
# source://bugsnag//lib/bugsnag/event.rb#4
Bugsnag::Event = Bugsnag::Report

# source://bugsnag//lib/bugsnag/feature_flag.rb#2
class Bugsnag::FeatureFlag
  ...
  #
  # source://bugsnag//lib/bugsnag/feature_flag.rb#15
  def initialize(name, variant = T.unsafe(nil)); end

  # source://bugsnag//lib/bugsnag/feature_flag.rb#20
  def ==(other); end

  # source://bugsnag//lib/bugsnag/feature_flag.rb#24
  def hash; end
  ...
  # @return [String]
  #
  # source://bugsnag//lib/bugsnag/feature_flag.rb#6
  def name; end
  ...
  # @return [Hash{String => String}]
  #
  # source://bugsnag//lib/bugsnag/feature_flag.rb#37
  def to_h; end
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/feature_flag.rb#49
  def valid?; end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/feature_flag.rb#11
  def variant; end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/feature_flag.rb#64
  def coerce_variant(variant); end
end

# source://bugsnag//lib/bugsnag/helpers.rb#2
module Bugsnag::Helpers
  class << self
    ...
    #
    # source://bugsnag//lib/bugsnag/helpers.rb#41
    ...
    #
    # source://bugsnag//lib/bugsnag/helpers.rb#57
    def deep_merge!(l_hash, r_hash); end

    # Wrapper for trimming stacktraces
    #
    # source://bugsnag//lib/bugsnag/helpers.rb#105
    def extract_exception(payload, &block); end

    # source://bugsnag//lib/bugsnag/helpers.rb#161
    ...
    # @return [Boolean]
    #
    # source://bugsnag//lib/bugsnag/helpers.rb#127
...
# source://bugsnag//lib/bugsnag/helpers.rb#71
Bugsnag::Helpers::TRUNCATION_INFO = T.let(T.unsafe(nil), String)

# source://bugsnag//lib/bugsnag.rb#40
Bugsnag::INTEGRATIONS = T.let(T.unsafe(nil), Array)

# source://bugsnag//lib/bugsnag.rb#39
...
#
# source://bugsnag//lib/bugsnag/middleware/rack_request.rb#4
class Bugsnag::Middleware::RackRequest
  ...
  # source://bugsnag//lib/bugsnag/middleware/rack_request.rb#12
  def call(report); end

  private

  # source://bugsnag//lib/bugsnag/middleware/rack_request.rb#158
  def add_cookies(report, request); end

  # source://bugsnag//lib/bugsnag/middleware/rack_request.rb#114
  def add_request_body(report, request, env); end

  # source://bugsnag//lib/bugsnag/middleware/rack_request.rb#94
  def format_headers(env, referer); end

  # source://bugsnag//lib/bugsnag/middleware/rack_request.rb#127
  def parsed_request_body(request, env); end

  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/middleware/rack_request.rb#168
...
# source://bugsnag//lib/bugsnag/middleware/rack_request.rb#5
...
# source://bugsnag//lib/bugsnag/integrations/railtie.rb#7
class Bugsnag::Railtie < ::Rails::Railtie
  ...
  #
  # source://bugsnag//lib/bugsnag/integrations/railtie.rb#17
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://bugsnag//lib/bugsnag/integrations/railtie.rb#62
    def rescue_in_active_record_callbacks?; end
  end
end

# source://bugsnag//lib/bugsnag/integrations/railtie.rb#8
Bugsnag::Railtie::FRAMEWORK_ATTRIBUTES = T.let(T.unsafe(nil), Hash)

# source://bugsnag//lib/bugsnag/report.rb#7
class Bugsnag::Report
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#117
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/report.rb#343
  def add_metadata(section, key_or_data, *args); end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/report.rb#179
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#32
  def api_key; end
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#37
  def app_type; end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/report.rb#41
  def app_version; end
  ...
  # @return [Hash]
  #
  # source://bugsnag//lib/bugsnag/report.rb#209
  def as_json; end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/report.rb#167
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#45
  def breadcrumbs; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/report.rb#360
  def clear_metadata(section, *args); end

  # @api private
  # @return [Configuration]
  #
  # source://bugsnag//lib/bugsnag/report.rb#49
  def configuration; end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/report.rb#154
  def context; end
  ...
  # @return [String, nil]
  #
  # source://bugsnag//lib/bugsnag/report.rb#160
  def context=(_arg0); end
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#54
  def delivery_method; end
  ...
  # @return [Array<Error>]
  #
  # source://bugsnag//lib/bugsnag/report.rb#109
  def errors; end
  ...
  # @return [Array<Hash>]
  #
  # source://bugsnag//lib/bugsnag/report.rb#59
  def exceptions; end
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#367
  ...
  # @return [String]
  #
  # source://bugsnag//lib/bugsnag/report.rb#72
  ...
  # @return [Hash{String => String}]
  #
  # source://bugsnag//lib/bugsnag/report.rb#254
  def headers; end

  # @return [String]
  # @see Configuration#hostname
  #
  # source://bugsnag//lib/bugsnag/report.rb#63
  def hostname; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/report.rb#282
  def ignore!; end
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/report.rb#266
  def ignore?; end
  ...
  # @return [Hash]
  #
  # source://bugsnag//lib/bugsnag/report.rb#77
  def meta_data; end
  ...
  # @return [Hash]
  #
  # source://bugsnag//lib/bugsnag/report.rb#309
  def metadata; end

  # @param metadata [Hash]
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/report.rb#315
  def metadata=(metadata); end
  ...
  # @return [Exception]
  #
  # source://bugsnag//lib/bugsnag/report.rb#113
  ...
  # @see #exceptions
  #
  # source://bugsnag//lib/bugsnag/report.rb#83
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#88
  def release_stage; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/report.rb#199
  ...
  # @return [Hash, nil]
  #
  # source://bugsnag//lib/bugsnag/report.rb#323
  def request; end
  ...
  # @return [Hash]
  #
  # source://bugsnag//lib/bugsnag/report.rb#274
  def request_data; end
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#68
  def runtime_versions; end
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#93
  def session; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/report.rb#382
  ...
  # @return [String]
  #
  # source://bugsnag//lib/bugsnag/report.rb#97
  def severity; end
  ...
  # @return [Hash]
  #
  # source://bugsnag//lib/bugsnag/report.rb#101
  ...
  #
  # source://bugsnag//lib/bugsnag/report.rb#290
  def summary; end
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/report.rb#27
  def unhandled; end

  # source://bugsnag//lib/bugsnag/report.rb#389
  ...
  # @return [Boolean]
  #
  # source://bugsnag//lib/bugsnag/report.rb#401
  ...
  # @return [Hash]
  #
  # source://bugsnag//lib/bugsnag/report.rb#105
  def user; end
  ...
  # source://bugsnag//lib/bugsnag/report.rb#446
  def error_class(exception); end

  # source://bugsnag//lib/bugsnag/report.rb#452
  def error_message(exception, class_name); end

  # Returns the value of attribute feature_flag_delegate.
  #
  # source://bugsnag//lib/bugsnag/report.rb#407
  def feature_flag_delegate; end

  # source://bugsnag//lib/bugsnag/report.rb#440
  def generate_error_list; end

  # source://bugsnag//lib/bugsnag/report.rb#428
  def generate_exception_list; end

  # source://bugsnag//lib/bugsnag/report.rb#479
  def generate_raw_exceptions(exception); end

  # source://bugsnag//lib/bugsnag/report.rb#409
  def update_handled_counts(is_unhandled, was_unhandled); end
end

# source://bugsnag//lib/bugsnag/report.rb#23
...
# source://bugsnag//lib/bugsnag/report.rb#21
...
# source://bugsnag//lib/bugsnag/report.rb#12
...
# source://bugsnag//lib/bugsnag/report.rb#19
...
#
# source://bugsnag//lib/bugsnag/integrations/sidekiq.rb#6
class Bugsnag::Sidekiq
  include ::Sidekiq::ServerMiddleware

  # @return [Sidekiq] a new instance of Sidekiq
  #
  # source://bugsnag//lib/bugsnag/integrations/sidekiq.rb#15
  def initialize; end

  # source://bugsnag//lib/bugsnag/integrations/sidekiq.rb#21
  def call(worker, msg, queue); end

  class << self
    # source://bugsnag//lib/bugsnag/integrations/sidekiq.rb#51
    def configure_server(server); end

    # source://bugsnag//lib/bugsnag/integrations/sidekiq.rb#37
    def notify(exception); end

    # source://bugsnag//lib/bugsnag/integrations/sidekiq.rb#47
    def sidekiq_supports_error_handlers; end
  end
end

# source://bugsnag//lib/bugsnag/integrations/sidekiq.rb#10
Bugsnag::Sidekiq::FRAMEWORK_ATTRIBUTES = T.let(T.unsafe(nil), Hash)
...
module Bugsnag::Stacktrace
  class << self
    ...
    # @return [Boolean]
    #
    # source://bugsnag//lib/bugsnag/stacktrace.rb#74
...
# source://bugsnag//lib/bugsnag/utility/feature_data_store.rb#1
...
#
# source://bugsnag//lib/bugsnag/utility/feature_data_store.rb#4
module Bugsnag::Utility::FeatureDataStore
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_data_store.rb#10
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_data_store.rb#22
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_data_store.rb#30
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_data_store.rb#37
  def clear_feature_flags; end
end

# @api private
#
# source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#3
class Bugsnag::Utility::FeatureFlagDelegate
  # @api private
  # @return [FeatureFlagDelegate] a new instance of FeatureFlagDelegate
  #
  # source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#4
  def initialize; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#23
  ...
  #
  # source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#85
  def as_json; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#59
  def clear; end
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#39
  ...
  # @return [void]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#52
  def remove(name); end
  ...
  # @return [Array<Bugsnag::FeatureFlag>]
  #
  # source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#72
  def to_a; end
  ...
  # @api private
  #
  # source://bugsnag//lib/bugsnag/utility/feature_flag_delegate.rb#11
