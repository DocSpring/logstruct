...
class Rollbar::Item::Frame
  ...
  # source://rollbar//lib/rollbar/item/frame.rb#86
  ...
  # source://rollbar//lib/rollbar/item/frame.rb#97
  def locals_data(filename, lineno); end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/item/frame.rb#65
  def outside_project?(filename); end

  # source://rollbar//lib/rollbar/item/frame.rb#103
  def post_data(file_lines, lineno); end

  # source://rollbar//lib/rollbar/item/frame.rb#111
  def pre_data(file_lines, lineno); end

  # @return [Boolean]
  #
  # source://rollbar//lib/rollbar/item/frame.rb#54
  def skip_extra_frame_data?(filename, file_lines); end

  # source://rollbar//lib/rollbar/item/frame.rb#38
