...
class Postmark::AccountApiClient < ::Postmark::Client
  ...
  # source://postmark//lib/postmark/account_api_client.rb#81
  def create_domain(attributes = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#31
  def create_sender(attributes = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#129
  def create_server(attributes = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#31
  def create_signature(attributes = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#109
  def delete_domain(id); end

  # source://postmark//lib/postmark/account_api_client.rb#60
  def delete_sender(id); end

  # source://postmark//lib/postmark/account_api_client.rb#139
  def delete_server(id); end

  # source://postmark//lib/postmark/account_api_client.rb#60
  def delete_signature(id); end

  # source://postmark//lib/postmark/account_api_client.rb#65
  def domains(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#149
  def get_data_removal_status(id); end

  # source://postmark//lib/postmark/account_api_client.rb#77
  def get_domain(id); end

  # source://postmark//lib/postmark/account_api_client.rb#69
  def get_domains(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#73
  def get_domains_count(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#26
  def get_sender(id); end

  # source://postmark//lib/postmark/account_api_client.rb#16
  def get_senders(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#21
  def get_senders_count(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#125
  def get_server(id); end

  # source://postmark//lib/postmark/account_api_client.rb#117
  def get_servers(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#121
  ...
  # source://postmark//lib/postmark/account_api_client.rb#143
  def push_templates(attributes = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#153
  def request_data_removal(attributes = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#55
  def request_new_sender_dkim(id); end

  # source://postmark//lib/postmark/account_api_client.rb#55
  def request_new_signature_dkim(id); end

  # source://postmark//lib/postmark/account_api_client.rb#45
  def resend_sender_confirmation(id); end

  # source://postmark//lib/postmark/account_api_client.rb#45
  def resend_signature_confirmation(id); end

  # source://postmark//lib/postmark/account_api_client.rb#105
  def rotate_domain_dkim(id); end

  # source://postmark//lib/postmark/account_api_client.rb#11
  def senders(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#113
  def servers(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#11
  def signatures(options = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#87
  def update_domain(id, attributes = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#38
  def update_sender(id, attributes = T.unsafe(nil)); end

  # source://postmark//lib/postmark/account_api_client.rb#134
  ...
  # @return [Boolean]
  #
  # source://postmark//lib/postmark/account_api_client.rb#101
  def verified_domain_spf?(id); end

  # @return [Boolean]
  #
  # source://postmark//lib/postmark/account_api_client.rb#50
  ...
  # source://postmark//lib/postmark/account_api_client.rb#93
  def verify_domain_dkim(id); end

  # source://postmark//lib/postmark/account_api_client.rb#97
