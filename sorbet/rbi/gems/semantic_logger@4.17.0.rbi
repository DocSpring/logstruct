...
# source://semantic_logger//lib/semantic_logger/appender/bugsnag.rb#14
class SemanticLogger::Appender::Bugsnag < ::SemanticLogger::Subscriber
  ...
  #           The Proc must return true or false.
  #
  # @return [Bugsnag] a new instance of Bugsnag
  #
  # source://semantic_logger//lib/semantic_logger/appender/bugsnag.rb#32
  def initialize(level: T.unsafe(nil), **args, &block); end

  # Returns [Hash] of parameters to send to Bugsnag.
  #
  # source://semantic_logger//lib/semantic_logger/appender/bugsnag.rb#43
  def call(log, logger); end

  # source://semantic_logger//lib/semantic_logger/appender/bugsnag.rb#53
  def log(log); end

  private

  # source://semantic_logger//lib/semantic_logger/appender/bugsnag.rb#66
  def bugsnag_notify(exception, hash, level); end

  # source://semantic_logger//lib/semantic_logger/appender/bugsnag.rb#78
  def extract_exception(log); end

  # Bugsnag supports: error, warning or info
  #
  # source://semantic_logger//lib/semantic_logger/appender/bugsnag.rb#91
...
# source://semantic_logger//lib/semantic_logger/appender/honeybadger.rb#14
class SemanticLogger::Appender::Honeybadger < ::SemanticLogger::Subscriber
  ...
  #     Default: SemanticLogger.application
  #
  # @return [Honeybadger] a new instance of Honeybadger
  #
  # source://semantic_logger//lib/semantic_logger/appender/honeybadger.rb#40
  def initialize(level: T.unsafe(nil), **args, &block); end

  # Send an error notification to honeybadger
  #
  # source://semantic_logger//lib/semantic_logger/appender/honeybadger.rb#45
  def log(log); end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/honeybadger.rb#65
  def default_formatter; end
end

# source://semantic_logger//lib/semantic_logger/appender/honeybadger_insights.rb#14
class SemanticLogger::Appender::HoneybadgerInsights < ::SemanticLogger::Subscriber
  ...
  #     Default: SemanticLogger.application
  #
  # @return [HoneybadgerInsights] a new instance of HoneybadgerInsights
  #
  # source://semantic_logger//lib/semantic_logger/appender/honeybadger_insights.rb#40
  def initialize(level: T.unsafe(nil), **args, &block); end

  # Send log to honeybadger events API
  #
  # source://semantic_logger//lib/semantic_logger/appender/honeybadger_insights.rb#45
  def log(log); end
  ...
  # Use Raw Formatter by default
  #
  # source://semantic_logger//lib/semantic_logger/appender/honeybadger_insights.rb#56
  def default_formatter; end
end
...
# source://semantic_logger//lib/semantic_logger/appender/sentry_ruby.rb#14
class SemanticLogger::Appender::SentryRuby < ::SemanticLogger::Subscriber
  ...
  #     Default: SemanticLogger.application
  #
  # @return [SentryRuby] a new instance of SentryRuby
  #
  # source://semantic_logger//lib/semantic_logger/appender/sentry_ruby.rb#40
  def initialize(level: T.unsafe(nil), **args, &block); end

  # Send an error notification to sentry
  #
  # source://semantic_logger//lib/semantic_logger/appender/sentry_ruby.rb#48
  def log(log); end
  ...
  # Use Raw Formatter by default
  #
  # source://semantic_logger//lib/semantic_logger/appender/sentry_ruby.rb#86
  def default_formatter; end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/sentry_ruby.rb#129
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/sentry_ruby.rb#98
