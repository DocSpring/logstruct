...
export default function GettingStartedPage() {
  return (
    <div className="space-y-6">
      ...
      <p className="text-neutral-600 dark:text-neutral-400 mb-4">
        While LogStruct works out of the box with zero configuration, you might want to customize it to better suit your application. Create a new file at <code className="px-1 py-0.5 bg-neutral-100 dark:bg-neutral-800 rounded">config/initializers/logstruct.rb</code> with the following content:
      </p>
...
Rails.logger.tagged("Authentication") do
  ...
  Rails.logger.info({ user_id: user.id, ip_address: request.remote_ip })
      ...
      <ul className="list-disc list-inside space-y-2 text-neutral-600 dark:text-neutral-400">
        <li><a href="/docs/configuration" className="text-blue-600 dark:text-blue-400 hover:underline">Configuration</a> - Learn how to customize LogStruct for your needs</li>
