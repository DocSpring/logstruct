...
# Usage: ruby scripts/generate_sorbet_log_structs.rb
...
TEMPLATES_DIR = T.let(File.join(ROOT, "scripts", "templates", "sorbet"), String)
...
class TemplateBinding
  ...
  def header(template_name)
    <<~RUBY.chomp
      ...
      # Template: scripts/templates/sorbet/#{template_name}
    RUBY
  end
