  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-neutral-600 dark:text-neutral-300">
        LogStruct requires Ruby <span className="text-gray-200">3.2.0</span> or higher.
      </p>
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              {requiredDeps.map((dep) => (
                <tr key={dep.name} className="border-b border-neutral-200 dark:border-neutral-700">
      ...
      <p className="text-neutral-600 dark:text-neutral-300 mb-4">
        LogStruct provides seamless integration with these gems, but they are not required for its
        core functionality.
      </p>
      ...
      <Callout type="info">
        <p>Please open a PR if you would like to add support for other gems or older versions.</p>
      </Callout>
      ...
      <p className="text-neutral-600 dark:text-neutral-300">
        To use LogStruct with any of the optional integrations, simply add the desired gem to your
        Gemfile and LogStruct will automatically detect and configure it. See the{' '}
        <a href="/docs/integrations">Integrations</a> page for more details and log examples.
      </p>
...
function getGemDescription(gemName: string): string {
  const descriptions: { [key: string]: string } = {
    ...
    'sentry-ruby': 'Error tracking that helps developers monitor and fix crashes',
