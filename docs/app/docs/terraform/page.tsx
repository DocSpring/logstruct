  ...
  return (
    <div className="space-y-10">
      ...
      <p className="text-neutral-600 dark:text-neutral-300">
        The LogStruct Terraform provider offers type-safe helpers for building CloudWatch filter
        patterns from your structured logs, and validates struct/event combinations at plan time.
      </p>

      <section id="installation" className="space-y-4">
        <h2 className="text-2xl font-semibold">Installation</h2>
        <p>
          Use the AWS module wrappers for common patterns. They resolve the provider internally and
          compile patterns safely.
        </p>
      </section>

      <section id="example" className="space-y-4">
        <h2 className="text-2xl font-semibold">CloudWatch Metric Filter Example</h2>
        <p>
          Module-first: create an AWS metric filter for a known LogStruct source/event combo.
          Invalid combinations fail at plan time.
        </p>
...
variable "namespace" { type = string }`}
      ...
      <section id="validation" className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            Structs and events are validated at plan time using the embedded LogStruct catalog
            exported from this repository.
          </li>
          <li>
            If allowed events or keys change in a newer LogStruct release, your Terraform plan will
      ...
      <section id="versioning" className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            Provider versions mirror LogStruct tags (for example, <code>v0.2.0</code>).
          </li>
          <li>
            Use a compatible constraint like <code>~&gt; 0.2</code> to receive non-breaking updates.
          </li>
        </ul>
      </section>
      ...
      <section id="recipes" className="space-y-4">
        ...
        <p className="text-neutral-600 dark:text-neutral-300">
          For delivery failures, use metric math to compare attempts vs. delivered counts.
          CloudWatch filter patterns do not support numeric comparisons, so slow-query thresholds
          are usually handled downstream (for example, count + percentiles in metrics/dashboards).
