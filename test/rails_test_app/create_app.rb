...
gemfile_path = File.join(TARGET_DIR, "rails_test_app", "Gemfile")
...
# Set up the database
Dir.chdir(File.join(TARGET_DIR, "rails_test_app")) do
  system("bundle install")
  system("bin/rails db:create db:migrate")
end

puts "Test Rails app created successfully in #{TARGET_DIR}/rails_test_app"
puts "To run the tests: cd #{TARGET_DIR}/rails_test_app && bin/rails test"